...
const translations = {
  en: {
    ...
    cancelAutolabeling: "Cancel autolabeling",
    ...
    autolabelBatchCancelled: "Autolabel batch cancelled",
    autolabelBatchCancelledProvider:
      "Autolabel batch and provider inference cancelled",
    autolabelBatchCancelledLocalOnly:
      "Autolabel batch cancelled locally; this provider does not support request cancellation",
    autolabelBatchCancelledProviderUnavailable:
      "Autolabel batch cancelled locally; the provider cancellation endpoint was unavailable",
    ...
    noModelsDescription: "Train a model first to see it here.",
    deleteModel: "Delete model",
    modelDeleted: "Model deleted",
    modelDeleteFailed: "Could not delete model",
    modelDeleteDescription:
      "This model will be permanently removed. If it is active, the newest remaining model will be activated.",
    deleteImages: "Delete images",
    imagesDeleted: "Images deleted",
    imagesDeleteFailed: "Could not delete images",
    imagesDeleteDescription: "Permanently delete {count} selected images?",
  ...
  pl: {
    ...
    cancelAutolabeling: "Anuluj autolabelowanie",
    noRetryableImages:
    ...
    autolabelBatchCancelled: "Paczka etykietowania została anulowana",
    autolabelBatchCancelledProvider:
      "Anulowano paczkę etykietowania oraz inferencje po stronie providera",
    autolabelBatchCancelledLocalOnly:
      "Paczka etykietowania została anulowana lokalnie; ten provider nie obsługuje anulowania żądań",
    autolabelBatchCancelledProviderUnavailable:
      "Paczka etykietowania została anulowana lokalnie; endpoint anulowania providera jest niedostępny",
    ...
    noModelsDescription: "Najpierw wytrenuj model, aby pojawił się na liście.",
    deleteModel: "Usuń model",
    modelDeleted: "Model został usunięty",
    modelDeleteFailed: "Nie udało się usunąć modelu",
    modelDeleteDescription:
      "Model zostanie trwale usunięty. Jeśli jest aktywny, aktywowany zostanie najnowszy z pozostałych modeli.",
    deleteImages: "Usuń zdjęcia",
    imagesDeleted: "Zdjęcia zostały usunięte",
    imagesDeleteFailed: "Nie udało się usunąć zdjęć",
    imagesDeleteDescription: "Czy trwale usunąć {count} zaznaczonych zdjęć?",
